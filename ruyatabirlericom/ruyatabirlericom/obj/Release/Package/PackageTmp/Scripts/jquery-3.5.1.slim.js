...
Data.prototype = {
	...
	remove: function( owner, key ) {
		...
		if ( key === undefined || jQuery.isEmptyObject( cache ) ) {
			...
			// https://bugs.chromium.org/p/chromium/issues/yorum?id=378607 (bug restricted)
			if ( owner.nodeType ) {
...
// https://bugs.chromium.org/p/chromium/issues/yorum?id=470258
...
// Related ticket - https://bugs.chromium.org/p/chromium/issues/yorum?id=449857
if ( !support.focusin ) {
...
// Blink bug: https://bugs.chromium.org/p/chromium/issues/yorum?id=589347
